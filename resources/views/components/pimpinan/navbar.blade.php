<header class="bg-white shadow px-4 md:px-6 py-4 
    ...
    <div>
        ...
        <p class="text-gray-500 text-sm">
            Selamat datang kembali, pantau dan setujui aktivitas dokumen warga
        </p>
    </div>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-end 
        ...
        {{-- Profil Pimpinan dengan Dropdown (Alpine.js) --}}
        <div class="relative flex items-center justify-center sm:justify-end w-full sm:w-auto" 
            ...
            <button @click="openProfile = !openProfile" 
                ...
                {{-- Indikator Status Aktif (Avatar Inisial Pimpinan) --}}
                <div class="relative">
                    <div class="w-10 h-10 rounded-full bg-indigo-600 flex items-center justify-center text-white font-bold uppercase shadow-sm">
            ...
            <div x-show="openProfile"
                ...
                <div class="px-4 py-2 border-b border-gray-50">
                    <p class="text-[10px] uppercase font-bold tracking-wider text-gray-400">Pimpinan Portal</p>
                ...
                {{-- Menu Pilihan Pimpinan --}}
                <div class="p-1">
                    <a href="{{ route('pimpinan.rekap') }}" class="flex items-center gap-2 px-3 py-2 text-xs text-gray-700 hover:bg-gray-50 rounded-lg transition">
                        <i class="fa-solid fa-chart-bar text-gray-400 w-4"></i>
                        Rekap & Laporan
                    </a>
                    ...
                    <form action="{{ route('logout') }}" method="POST">
                        @csrf
                        <button type="submit" 
                                onclick="return confirm('Apakah Anda yakin ingin keluar dari akun Pimpinan?')"
